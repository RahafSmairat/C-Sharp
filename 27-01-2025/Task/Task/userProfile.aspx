    ...
    <form id="form1" runat="server">
     ...
     <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
             ...
             <div class="d-flex">
                 <asp:Button runat="server" ID="profile" class="btn btn-outline-success" Text="My Profile" OnClick="profile_Click" />
             </div>
         </div>
     </div>
 </nav>
        ...
        <div class="row row-cols-md-4 justify-content-center">
            <div class="col-4">
                <div class="card">
                    <div style="height: 500px">
                        <img src="https://i.etsystatic.com/16895790/r/il/35fd84/4829165436/il_570xN.4829165436_anmw.jpg" class="card-img-top" alt="..." />
                    </div>
                    <div class="card-body">
            ...
            <div class="col-4">
                <div class="card">
                    <div style="height: 500px">
                        <img src="https://cdn.prod.website-files.com/62196607bf1b46c300301846/6568ae33daf5cb0b75e26ee6_frsoeroe7prviafnog2q.webp" class="card-img-top" alt="..." />
                    </div>
                    <div class="card-body">
